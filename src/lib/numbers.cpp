...
thread_local CryptoPP::AutoSeededRandomPool germ::random_pool;
...
void germ::uint256_union::encode_account (std::string & destination_a) const
{
    ...
    germ::uint512_t number_l (number ());
    number_l <<= 40;
    number_l |= germ::uint512_t (check);
    for (auto i (0); i < 60; ++i)
    {
...
std::string germ::uint256_union::to_account_split () const
{
...
std::string germ::uint256_union::to_account () const
{
    std::string result;
...
bool germ::uint256_union::decode_account (std::string const & source_a)
{
    ...
    *this = (number_l >> 40).convert_to<germ::uint256_t> ();
...
germ::uint256_union::uint256_union (germ::uint256_t const & number_a)
{
    germ::uint256_t number_l (number_a);
...
bool germ::uint256_union::operator== (germ::uint256_union const & other_a) const
{
    return bytes == other_a.bytes;
}

// Construct a uint256_union = AES_ENC_CTR (cleartext, key, iv)
void germ::uint256_union::encrypt (germ::raw_key const & cleartext, germ::raw_key const & key, uint128_union const & iv)
{
...
bool germ::uint256_union::is_zero () const
{
    return qwords[0] == 0 && qwords[1] == 0 && qwords[2] == 0 && qwords[3] == 0;
}

std::string germ::uint256_union::to_string () const
{
    std::string result;
    encode_hex (result);
    return result;
...
germ::uint256_union & germ::uint256_union::operator^= (germ::uint256_union const & other_a)
{
...
germ::uint256_union germ::uint256_union::operator^ (germ::uint256_union const & other_a) const
{
...
germ::uint256_union::uint256_union (std::string const & hex_a)
{
    decode_hex (hex_a);
}

void germ::uint256_union::clear ()
{
    qwords.fill (0);
}

germ::uint256_t germ::uint256_union::number () const
{
    germ::uint256_t result;
    auto shift (0);
...
void germ::uint256_union::encode_hex (std::string & text) const
{
    assert (text.empty ());
...
bool germ::uint256_union::decode_hex (std::string const & text)
{
    auto error (false);
...
void germ::uint256_union::encode_dec (std::string & text) const
{
    assert (text.empty ());
    std::stringstream stream;
...
bool germ::uint256_union::decode_dec (std::string const & text)
{
...
germ::uint256_union::uint256_union (uint64_t value0)
{
    *this = germ::uint256_t (value0);
}
...
bool germ::uint512_union::operator== (germ::uint512_union const & other_a) const
{
    return bytes == other_a.bytes;
}

germ::uint512_union::uint512_union (germ::uint512_t const & number_a)
{
    germ::uint512_t number_l (number_a);
    for (auto i (bytes.rbegin ()), n (bytes.rend ()); i != n; ++i)
    {
        *i = static_cast<uint8_t> (number_l & static_cast<uint8_t> (0xff));
        number_l >>= 8;
...
germ::uint512_union::uint512_union (std::string const & hex_a)
{
    decode_hex (hex_a);
}

void germ::uint512_union::clear ()
{
    bytes.fill (0);
}

germ::uint512_t germ::uint512_union::number () const
{
    germ::uint512_t result;
    auto shift (0);
    for (auto i (bytes.begin ()), n (bytes.end ()); i != n; ++i)
    {
        result <<= shift;
...
void germ::uint512_union::encode_hex (std::string & text) const
{
    assert (text.empty ());
    std::stringstream stream;
...
bool germ::uint512_union::decode_hex (std::string const & text)
{
...
germ::uint512_union & germ::uint512_union::operator^= (germ::uint512_union const & other_a)
{
...
std::string germ::uint512_union::to_string () const
{
    std::string result;
    encode_hex (result);
    return result;
...
germ::raw_key::~raw_key ()
{
    data.clear ();
}

bool germ::raw_key::operator== (germ::raw_key const & other_a) const
{
...
void germ::raw_key::decrypt (germ::uint256_union const & ciphertext, germ::raw_key const & key_a, uint128_union const & iv)
{
...
germ::uint512_union germ::sign_message (germ::raw_key const & private_key, germ::public_key const & public_key, germ::uint256_union const & message)
{
    germ::uint512_union result;
    ed25519_sign (message.bytes.data (), sizeof (message.bytes), private_key.data.bytes.data (), public_key.bytes.data (), result.bytes.data ());
    return result;
}

void germ::deterministic_key (germ::uint256_union const & seed_a, uint32_t index_a, germ::uint256_union & prv_a)
{
    blake2b_state hash;
...
bool germ::validate_message (germ::public_key const & public_key, germ::uint256_union const & message, germ::uint512_union const & signature)
{
    auto result (0 != ed25519_sign_open (message.bytes.data (), sizeof (message.bytes), public_key.bytes.data (), signature.bytes.data ()));
    return result;
}

germ::uint128_union::uint128_union (std::string const & string_a)
{
    decode_hex (string_a);
}

germ::uint128_union::uint128_union (uint64_t value_a)
{
    *this = germ::uint128_t (value_a);
}

germ::uint128_union::uint128_union (germ::uint128_t const & value_a)
{
    germ::uint128_t number_l (value_a);
    for (auto i (bytes.rbegin ()), n (bytes.rend ()); i != n; ++i)
    {
        *i = static_cast<uint8_t> (number_l & static_cast<uint8_t> (0xff));
        number_l >>= 8;
...
bool germ::uint128_union::operator== (germ::uint128_union const & other_a) const
{
...
germ::uint128_t germ::uint128_union::number () const
{
...
void germ::uint128_union::encode_hex (std::string & text) const
{
    assert (text.empty ());
    std::stringstream stream;
...
bool germ::uint128_union::decode_hex (std::string const & text)
{
...
void germ::uint128_union::encode_dec (std::string & text) const
{
    assert (text.empty ());
    std::stringstream stream;
    stream << std::dec << std::noshowbase;
...
bool germ::uint128_union::decode_dec (std::string const & text)
{
    ...
    {
        stream >> number_l;
        germ::uint128_t unchecked (number_l);
        *this = unchecked;
        if (stream.eof ())
            return error;
...
void format_frac (std::ostringstream & stream, germ::uint128_t value, germ::uint128_t scale, int precision)
{
    auto reduce = scale;
    auto rem = value;
...
void format_dec (std::ostringstream & stream, germ::uint128_t value, char group_sep, const std::string & groupings)
{
    auto largestPow10 = germ::uint256_t (1);
    int dec_count = 1;
    while (1)
    {
    ...
    auto reduce = germ::uint128_t (largestPow10);
    germ::uint128_t rem = value;
    while (reduce > 0)
    {
        auto val = rem / reduce;
        rem -= val * reduce;
...
std::string format_balance (germ::uint128_t balance, germ::uint128_t scale, int precision, bool group_digits, char thousands_sep, char decimal_point, std::string & grouping)
{
...
std::string germ::uint128_union::format_balance (germ::uint128_t scale, int precision, bool group_digits)
{
...
std::string germ::uint128_union::format_balance (germ::uint128_t scale, int precision, bool group_digits, const std::locale & locale)
{
...
void germ::uint128_union::clear ()
{
    qwords.fill (0);
}

bool germ::uint128_union::is_zero () const
{
    return qwords[0] == 0 && qwords[1] == 0;
}

std::string germ::uint128_union::to_string () const
{
    std::string result;
    encode_hex (result);
    return result;
...
std::string germ::uint128_union::to_string_dec () const
{
    std::string result;
    encode_dec (result);
    return result;
